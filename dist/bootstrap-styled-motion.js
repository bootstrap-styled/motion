(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('styled-components'), require('classnames'), require('lodash.omit'), require('map-to-css-modules')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'styled-components', 'classnames', 'lodash.omit', 'map-to-css-modules'], factory) :
	(factory((global['bootstrap-styled-motion'] = {}),global.React,global.PropTypes,global.styled,global.classnames,global.lodash.omit,global['map-to-css-modules']));
}(this, (function (exports,React,PropTypes,styledComponents,cn,omit,mapToCssModules) { 'use strict';
